...
<head>
	...
	<!-- Hotjar Tracking Code for Abbington House -->
	<script>
...
<body <?php body_class(); ?> itemscope itemtype="http://schema.org/WebPage">
	...
	<header class="header">
	    ...
	    <div class="header__wrapper">
			...
			<?php $header_number = get_field('header_number', 'option'); ?>

			<a class="header__button" href="tel:<?php echo($header_number) ?>">
			<p>Give us a call</p>
			<p><?php echo($header_number) ?></p>
			</a>

			<a href="tel:<?php echo($header_number) ?>" class="header__call-icon">
